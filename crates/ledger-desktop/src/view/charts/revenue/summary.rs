...
fn calculate(
    ...
    // Sum daily balances across all revenue accounts for the entire period
    ...
    for amount in total_balance.iter() {
        ...
        result.insert(amount.commodity.clone(), value);
    }
    result
}
    ...
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        v_flex()
            ...
            .children(all_commodities.into_iter().map(|commodity| {
                ...
                // For revenue, more is good (green), less is bad (red)
